            ...
            <header>
                <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <NavLink className="p-2 text-white" to="/home">Home</NavLink>
                        <NavLink className="p-2 text-white" to="/about">About</NavLink>
                        <NavLink className="p-2 text-white" to="/services">Services</NavLink>
                        <NavLink className="p-2 text-white" to="/contact">Contact</NavLink>
